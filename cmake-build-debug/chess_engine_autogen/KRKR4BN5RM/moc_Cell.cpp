...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_UI__Cell_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_UI__Cell_t qt_meta_stringdata_UI__Cell = {
    {
QT_MOC_LITERAL(0, 0, 8) // "UI::Cell"
...
QT_INIT_METAOBJECT const QMetaObject UI::Cell::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_UI__Cell.data,
    qt_meta_data_UI__Cell,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *UI::Cell::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_UI__Cell.stringdata0))
